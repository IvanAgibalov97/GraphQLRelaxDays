...
var TranslationController = (function (_super) {
    __extends(TranslationController, _super);
    function TranslationController(port) {
        var _this = _super.call(this) || this;
        _this._translaterURL = "";
        _this._translaterURL = "http://localhost:" + port;
        return _this;
    }
    TranslationController.prototype.translate = function (from, to, text) {
        return from + to + text;
    };
    TranslationController.prototype.createConnection = function (controllers) { };
    TranslationController.prototype.start = function () {
